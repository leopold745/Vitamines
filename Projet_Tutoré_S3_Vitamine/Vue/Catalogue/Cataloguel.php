...
<body>
    ...
    $result = mysqli_query($co, "SELECT P.id_Produit,P.nom,P.prixAuKilo,P.stock,P.imageProduit FROM Produit P,categorieproduit CP WHERE P.id_Cat=CP.id_Cat AND CP.type='Legume' ") or die("erreur requete");
