...
<body>
    ...
    echo '<div class="row pt-5 d-flex justify-content-center">';
    echo '<div class="col-lg-6 mb-3 mb-lg-0">';
    echo '<div class="hover hover-3 text-white rounded"><img src="../../ImageProduit/Panier_Saison.jpg" alt="">';
    echo '<div class="hover-overlay"></div>';
    echo '<div class="hover-3-content">';
    echo '<h3 class="hover-3-title text-uppercase font-weight-bold mb-1">Panier Saison d\'Hiver</h3>';
    echo '<p class="hover-3-description small text-uppercase mb-0">Comporte un assortiment de fruit et légume d\'hiver</p>';
    echo '<form method="POST" action="../../controlleurs/AjouterPanierHebdo.php">';
    echo '<div class="hover-3-description">';
    echo '<input type="number" name="nbPersonne" placeholder="Entrez la quantité" class="numberPanier" required>';
    echo '<br>';
    ...
    $result = mysqli_query($co, "SELECT id_Produit,nom,prixAuKilo,stock,imageProduit FROM Produit") or die("erreur requete");
    ...
    while($row = mysqli_fetch_assoc($result)){
      ...
      $imageProduit=$row['imageProduit'];
        echo '<div class="col-lg-6 mb-3 mt -3">';
